...
export const Dashboard: FC = () => {
    ...
    return <div className="bg-gray-100 dark:bg-gray-900 dark:text-white text-gray-600 max-w-6xl mx-auto flex overflow-hidden text-sm mt-14 border-t">
        {/*
        ...
        <div className="flex-grow overflow-hidden h-full flex flex-col">
            <div className="flex-grow flex overflow-x-hidden">
                <div className="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 h-full min-h-[50vh] overflow-y-auto lg:block hidden p-5">
                    <AppListing />
                </div>
