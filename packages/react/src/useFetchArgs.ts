...
export default function useFetchArgs(
    ...
    const context = useContext(SecretariumContext);
    ...
    const overwriteGlobalOptions = useMemo(() => {
        ...
        return;
    }, [optionsOrOverwriteGlobalOrDeps, urlOrPathOrOptionsOrOverwriteGlobalOptions]);
    ...
    const options = useMemo(() => {
        ...
        const globalOptions = context.options;
        const finalOptions = {
            ...defaults,
            ...globalOptions,
            ...localOptions,
        ...
        return finalOptions;
    }, [urlOrPathOrOptionsOrOverwriteGlobalOptions, optionsOrOverwriteGlobalOrDeps, context.options, overwriteGlobalOptions]);
