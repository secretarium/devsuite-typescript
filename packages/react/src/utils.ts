...
import { RequestInitJSON, Options, RetryOpts, Res, HTTPMethod, ResponseType } from './types';
...
export const isFunction = (v: any): v is (options: RetryOpts) => any => typeof v === 'function';
...
export const responseFields: ResponseFields[] = ['headers', 'ok', 'redirected', 'status', 'statusText', 'type', 'url', 'body', 'bodyUsed', 'data'];
/**
...
export const toResponseObject = <TData = any>(res?: Response | MutableRefObject<Response>, data?: any): Res<TData> => Object.defineProperties<Partial<Res<TData>>>(
    {},
...
export const useDeepQueryCallback = (cb: () => (...args: any) => any, deps: DependencyList) => useCallback(cb, useDeepCompareMemoize(deps));
