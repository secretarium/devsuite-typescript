...
export const ErrorMessage: Record<ErrorCodes, string> = {
    ...
    [ErrorCodes.ETIMOCHEG]: 'Timeout after client hello to gateway',
    [ErrorCodes.ETIMOCPOW]: 'Timeout after client proof-of-work',
    [ErrorCodes.ETIMOAHEL]: 'Timeout after application connect',
    ...
    [ErrorCodes.EUNABLCOA]: 'Unable to connect to the application: ',
